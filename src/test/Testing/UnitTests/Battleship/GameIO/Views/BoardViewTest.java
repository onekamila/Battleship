...
public class BoardViewTest
{
    ...
    {
        testGame = new Game();
        testBoard1 = testGame.getCurrentPlayer().getBoard();
        testBoard2 = testGame.getCurrentOpponent().getBoard();
        testFleet1 = testGame.getCurrentPlayer().getFleet();
        testFleet2 = testGame.getCurrentOpponent().getFleet();
        testShip1 = testFleet1.get(0);
        testShip2 = testFleet2.get(0);
        testView = new BoardView(testGame);
    }
